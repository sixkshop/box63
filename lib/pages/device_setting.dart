...
class _DeviceSettingPageState extends State<DeviceSettingPage> {
          ...
          if (parts0[0] == "m") {
            ...
            if (globals.motorDirection == "cc") {
              if (globals.motorStatus == "off") {
                ...
                textSpeed = (((double.parse(parts[2].trim()) - 550) / 3) / 10)
                    .toString();
              }
            } else {
              if (globals.motorStatus == "off") {
  ...
  Widget build(BuildContext context) {
    ...
    globals.args = ModalRoute.of(context).settings.arguments;
    ...
    if (firstOpen) {
      ...
      textSpeed = (((double.parse(globals.motorSpeed.trim()) - 550) / 3) / 10)
          .toString();
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text("Status : "),
                                                      Text(globals.lightStatus,
                                                          style: TextStyle(
                                                            color: Colors.black,
                                                          )),
                                                    ],
                                                  ),
                                                  Text("Mode : $textLightMode"),
                                                  Visibility(
                                                    child: Row(
                                                      children: [
                                                        Text("Color : "),
